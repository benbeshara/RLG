//
// Created by Ben Beshara on 8/7/2022.
//

#ifndef RLG_CMAKE_TEXTRECTEX_H
#define RLG_CMAKE_TEXTRECTEX_H

#include "raylib.h"

static void
DrawTextRecEx(Font font, const char *text, Rectangle rec, float fontSize, float spacing, bool wordWrap, Color tint,
